...
public class AfficherQuestionnaireQuestion extends ActionSupport implements SessionAware{
		/**
	 * 
	 */
...
//			System.out.println("nombre de questions: "+questionServ.listerQuestions(lgQuestionnaireSelected));
